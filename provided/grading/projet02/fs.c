...
static int fs_getattr(const char *path, struct stat *stbuf)
{
    ...
    // correcteur: tester ROOT_INUMBER aussi
                      ...
                      off_t offset, struct fuse_file_info *fi)
{
    ...
    // correcteur: tester aussi avec ROOT_INUMBER pour le range
    ...
    do {
        ...
        // correcteur: propagation des erreurs
                   ...
                   struct fuse_file_info *fi)
{
    ...
    // correcteur: vérifier si l'inode est alloué et si c'est un fichier
