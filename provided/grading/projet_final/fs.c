...
static int fs_getattr(const char *path, struct stat *stbuf)
{
    ...
    // correcteur: inr < ROOT_INUMBER est aussi considéré comme une erreur
                      ...
                      off_t offset, struct fuse_file_info *fi)
{
    ...
    do {
        ...
        // correcteur: filler retourne un code d'erreur en cas d'échec (à propager)
                   ...
                   struct fuse_file_info *fi)
{
    ...
    // correcteur: il manque encore un bloc. La division entière donne le nombre de blocs entiers
    // contenus dans size. Mais il reste encore le bloc "partiel" à la fin.
